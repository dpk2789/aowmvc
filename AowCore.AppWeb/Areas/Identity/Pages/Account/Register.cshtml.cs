...
namespace AowCore.AppWeb.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    htmlString = htmlString.Replace("@@sitename@@", "Accounting On Web")
                         .Replace("@@emailid@@", user.Email)
                         .Replace("@@accountcreated@@", DateTime.Now.ToString("dd-MM-yyyy"))
                          .Replace("@@activationlink@@", callbackUrl);

                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email", htmlString);
