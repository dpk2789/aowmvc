...
namespace AowCore.AppWeb.Areas.MyBooks.Controllers
{
    ...
    public class VouchersController : Controller
    {
        ...
        public VouchersController(IApplicationDbContext context, ICookieHelper cookieHelper,
        ...
        public async Task<IActionResult> Create(string data, decimal Invoice, DateTime Date, string voucherName)
        {
            if (ModelState.IsValid)
            {
                if (data != null)
                {
                    try
                    {
                        ...
                        await _voucherViewModelService.CreateVourcherAsync(voucherName, data, Invoice, Date, fyrId);
                        // return RedirectToAction(nameof(Index));
                        return Json(new { success = true, newLocation = voucherName });
                    }
                    catch (Exception ex)
                    {
